...
ensure_installed = { "prettier", "stylua" },
  ...
  polish = function()
      ...
      powershell = Terminal:new({ cmd = "pwsh", dir = "%:p:h" })
      toggle_powershell = function()
          powershell:toggle()
      end,
      -- set autocommands
      ...
      vim.api.nvim_set_keymap("n", "<leader>ts", "<cmd>lua toggle_powershell()<CR>", {noremap = true, silent = true, desc = "Toggle float powershell"})
      vim.api.nvim_set_keymap("n", "<c-\\>", "<cmd>lua toggle_powershell()<CR>", {noremap = true, silent = true, desc = "Toggle float powershell"})
